...
import { LinkedinIcon, TwitterIcon, GithubIcon, InstagramIcon } from 'lucide-react';
            ...
            <motion.div className='flex flex-col max-md:items-center max-md:text-center gap-2 items-end' initial={{ x: 150, opacity: 0 }} whileInView={{ x: 0, opacity: 1 }} viewport={{ once: true }} transition={{ type: 'spring', stiffness: 280, damping: 70, mass: 1 }}>
                ...
                <div className='flex items-center gap-4 mt-3'>
                    <a href='https://x.com/thenaveengautam' target='_blank' rel='noreferrer'>
                        <TwitterIcon className='size-5 hover:text-pink-600' />
                    </a>
                    <a href='https://www.linkedin.com/in/thenaveengautam/' target='_blank' rel='noreferrer'>
                        <LinkedinIcon className='size-5 hover:text-pink-600' />
                    </a>
                    <a href='https://www.instagram.com/iamnaveen._' target='_blank' rel='noreferrer'>
                        <InstagramIcon className='size-6 hover:text-pink-600' />
                    </a>
                    <a href='https://github.com/thenaveengautam' target='_blank' rel='noreferrer'>
                        <GithubIcon className='size-5 hover:text-pink-600' />
                    </a>
                </div>
                <p className='mt-3 text-center'>
                    &copy; {new Date().getFullYear()} Thumblify - <a className='hover:text-pink-600' href='https://naveengautam.dev'>Naveen Gautam</a>
                </p>
            </motion.div>
        </footer>
    );
